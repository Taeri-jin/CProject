...
#pragma region 동적 할당
	...
	// 동적 할당은 실행 시간에 가변적으로 메모리의 크기를 변경시킬 수 있으며, 동적으로 메모리의 크기를 할당할 때 바이트 단위로 지정

	// int * ptr = (int *)malloc(sizeof(int));

	// 메모리 동적 할당할 때 주소를 범용 포인터로 반환하기 때문에 자료형을 변환한 다음 메모리에 할당해야 함
	// *ptr = 1000;
